...
mtfll.automato.adicionarTransicao({["q1", "X"] => [["q2" ,"X", "E"]]})
...
mtfll.automato.adicionarTransicao({["q16", "a"] => [["q10" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q16", "u"] => [["q4" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q16", "c"] => [["q7" ,"X", "D"]]})
...
mtfll.automato.adicionarTransicao({["q4", "X"] => [["q5" ,"X", "E"]]})
...
mtfll.automato.adicionarTransicao({["q15", "g"] => [["q1" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q15", "a"] => [["q10" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q15", "c"] => [["q7" ,"X", "D"]]})
...
mtfll.automato.adicionarTransicao({["q7", "X"] => [["q8" ,"X", "E"]]})
...
mtfll.automato.adicionarTransicao({["q14", "g"] => [["q1" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q14", "u"] => [["q4" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q14", "a"] => [["q10" ,"X", "D"]]})
...
mtfll.automato.adicionarTransicao({["q10", "X"] => [["q11" ,"X", "E"]]})
...
mtfll.automato.adicionarTransicao({["q13", "g"] => [["q1" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q13", "u"] => [["q4" ,"X", "D"]]})
mtfll.automato.adicionarTransicao({["q13", "c"] => [["q7" ,"X", "D"]]})
